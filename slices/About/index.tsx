...
const About: FC<AboutProps> = ({ slice }) => {
	...
	return (
		<section
			...
			id="about"
		>
			<div className="relative flex min-h-[50svh] lg:min-h-[80svh] w-full items-center justify-center overflow-hidden">
				...
				<motion.div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center px-6 py-16 text-center">
					...
					<div className="mt-6 max-w-4xl text-2xl text-justify lg:text-center uppercase sm:text-4xl md:text-5xl">
